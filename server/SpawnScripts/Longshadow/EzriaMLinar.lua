...
function hailed(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/merchant_ezria_milnar/fprt_hood05/std_de_female_ezria_mlinar.mp3", "", "", 1300269011, 2618097834, Spawn)
	AddConversationOption(conversation, "I'm still deciding. I'll let you know if I want anything.", "dlg_1_1")
	AddConversationOption(conversation, "What is Neriak?")
...
function dlg_1_1(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/merchant_ezria_milnar/fprt_hood05/std_de_female_ezria_mlinar003.mp3", "", "", 1051883363, 861878972, Spawn)
	AddConversationOption(conversation, "Who are the Teir'Dal?")
...
function dlg_1_2(NPC, Spawn)
	...
	PlayFlavor(NPC, "voiceover/english/merchant_ezria_milnar/fprt_hood05/std_de_female_ezria_mlinar004.mp3", "", "", 2552789619, 2468887624, Spawn)
