--[[
	Script Name	: SpawnScripts/EnchantedLands/anArcaneScienceapprentice.lua
...
function hailed(NPC, Spawn)
	...
	if choice == 1 then
		PlayFlavor(NPC, "", "Now the storms are bringing invading forces into Norrath!", "", 1689589577, 4560189, Spawn)
