...
function hailed(NPC, Spawn)
	...
	if choice == 1 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_isle_speech_5.mp3", "Prove yourself, and I shall grant you shelter at the edge of my city, and the chance to earn your place as a proud citizen of Freeport.", "", 4115014723, 2723692261)
	elseif choice == 2 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_isle_speech_6.mp3", "Go now, and begin the trials that I have set for you.", "", 1244918730, 586509135)
	elseif choice == 3 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_isle_speech_7.mp3", "Succeed, and you will share the fortunes of Freeport as we reshape this broken world.", "", 2666628260, 1943756642)
	elseif choice == 4 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_isle_speech_8.mp3", "Together we will restore the glory of ages past, crush the Sons of Zek, and sweep aside the decadent nation of Qeynos!", "", 140890899, 2835297833)
	elseif choice == 5 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_isle_speech_9.mp3", "With my guidance, you shall gain power and glory as you have never imagined, but should you turn against me, you will find that my wrath is a terrible thing ... Now go!", "", 3855854568, 2247480313)
	elseif choice == 6 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_speechstrength001_64_64.mp3", "Citizens of Freeport! You have come from distant lands, driven by cataclysm and conflict into the welcoming shelter of my walls. You have proven your strength and your courage, else you would have been left beyond to wither and die. There is no place for mercy in these shattered lands; this is a time of blood and battle, and I only have need of the strong.", "", 2120743827, 2562003808)
	elseif choice == 7 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/lucan_speechstrength002_64_64.mp3", "But there are those among you who know little of my past and my glorious deed. I am Lucan D'Lere, and it is my will and steel that brought Freeport safely through the Age of Cataclysms. Even before the land was broken, I was renowned as a warrior, and I was chosen to rule this glorious city.", "", 1988024407, 1968035950)
	...
	elseif choice == 11 then
		PlayFlavor(NPC, "voiceover/english/overlord_lucan_d_lere/fprt_west/200_statue_overlord_lucan_dlere_speech_glory_freeport_4_658d5802.mp3", "And in the centuries that followed, it was my strength and my will that raised this city from the ashes and guided its people to the present. Now the Age of Destiny is upon us. The old world is shattered and will never return. As I restored Freeport, I will reshape Norrath.", "", 2738035237, 1024471311)
