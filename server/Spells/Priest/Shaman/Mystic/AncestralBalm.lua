--[[
    ...
    Script Date    : 2019.10.17 01:10:52
    Script Purpose : 
                   : 
--]]

-- Info from spell_display_effects (remove from script when done)
-- Dispels 86 levels of any hostile effects on target
-- Dispels 86 levels of hostile Fear effects on target
...
--         You cannot cast this spell while under the effects of something that supresses the use of group cures!
-- Dispels 86 levels of hostile Stun effects on target
